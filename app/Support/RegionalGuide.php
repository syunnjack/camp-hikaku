...
class RegionalGuide
{
    public const REGIONS = [
        'metropolitan' => ['label'=>'首都圏', 'areas'=>'東京・神奈川・千葉・埼玉', 'eyebrow'=>'TOKYO · KANAGAWA · CHIBA · SAITAMA', 'checked_at'=>'2026-09-08', 'published_at'=>'2026-09-09'],
        'kansai' => ['label'=>'関西', 'areas'=>'大阪・京都・兵庫・奈良・滋賀・和歌山', 'eyebrow'=>'OSAKA · KYOTO · HYOGO · NARA · SHIGA · WAKAYAMA', 'checked_at'=>'2026-09-09', 'published_at'=>'2026-09-09'],
    ];
