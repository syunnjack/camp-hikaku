...
<div class="discovery-wrap metro-guide">
  ...
  @if(($city==='shinjuku' || isset(\App\Support\WardGuide::METROS[$city])))<p><a class="discovery-button" href="{{ route('wards.index',$city==='shinjuku'?'tokyo':$city) }}">{{ $city==='shinjuku'?'東京23区':'区別' }}から施設を探す →</a></p>@endif
